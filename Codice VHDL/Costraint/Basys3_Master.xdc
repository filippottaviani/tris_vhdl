...
#set_property PACKAGE_PIN V15 [get_ports b5]					
	#set_property IOSTANDARD LVCMOS33 [get_ports b5]
#set_property PACKAGE_PIN W14 [get_ports b6]					
	#set_property IOSTANDARD LVCMOS33 [get_ports b6]
#set_property PACKAGE_PIN W13 [get_ports b7]					
...
#set_property PACKAGE_PIN T18 [get_ports turnON]						
	#set_property IOSTANDARD LVCMOS33 [get_ports turnON]
#set_property PACKAGE_PIN W19 [get_ports turnOFF]						
	#set_property IOSTANDARD LVCMOS33 [get_ports turnOFF]
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports b0]					
	set_property IOSTANDARD LVCMOS33 [get_ports b0]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports b1]					
	set_property IOSTANDARD LVCMOS33 [get_ports b1]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports b2]					
	set_property IOSTANDARD LVCMOS33 [get_ports b2]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports b3]					
	set_property IOSTANDARD LVCMOS33 [get_ports b3]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports b4]					
	set_property IOSTANDARD LVCMOS33 [get_ports b4]
##Sch name = JB8
#set_property PACKAGE_PIN A17 [get_ports b0]					
	#set_property IOSTANDARD LVCMOS33 [get_ports b6]
##Sch name = JB9
#set_property PACKAGE_PIN C15 [get_ports b0]					
	#set_property IOSTANDARD LVCMOS33 [get_ports b7]
##Sch name = JB10 
#set_property PACKAGE_PIN C16 [get_ports b0]					
	#set_property IOSTANDARD LVCMOS33 [get_ports b8]
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports b5]					
	set_property IOSTANDARD LVCMOS33 [get_ports b5]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports b6]					
	set_property IOSTANDARD LVCMOS33 [get_ports b6]
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports b7]					
	set_property IOSTANDARD LVCMOS33 [get_ports b7]
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports b8]					
	set_property IOSTANDARD LVCMOS33 [get_ports b8]
##Sch name = JC7
...
set_property PACKAGE_PIN A18 [get_ports data_out]						
